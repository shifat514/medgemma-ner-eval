...
|---|---|---|---|---|
| Medication | 0.8263 | 0.6412 | 0.7221 | 3799 |
| Dose | 0.8102 | 0.5920 | 0.6841 | 1875 |
| Mode | 0.6840 | 0.2522 | 0.3685 | 1717 |
| Frequency | 0.7714 | 0.4613 | 0.5774 | 1836 |
| Duration | 0.8161 | 0.7459 | 0.7794 | 488 |
| Reason | 0.7511 | 0.6892 | 0.7188 | 1287 |
| | | | | |
| **micro avg** | 0.7917 | 0.5524 | 0.6507 | 11002 |
| **macro avg** | 0.7765 | 0.5636 | 0.6417 | 11002 |
| **weighted avg** | 0.7830 | 0.5524 | 0.6385 | 11002 |
...
| **generation hit `max_new_tokens`** | **0 / 561 (0.0%)** |
...
| | |
|---|---|
| gold spans scored | 11,002 |
| gold spans per chunk | 19.6 |
| entities extracted per chunk | 23.9 |
| items emitted per gold span | 1.22x |
| ...of which is chunk overlap, not error | 1.23x |
| **over-extraction vs a perfect extractor** | **0.99x** |
| final predicted **spans** after alignment + dedupe | 7,676 |
| predicted spans per gold span | 0.70x |
...
| spans produced by alignment, before dedupe | 7,676 |
...
| **final predicted spans scored** | **7,676** |
